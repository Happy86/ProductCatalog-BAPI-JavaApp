/*
 * @class   backend.ProductCatalog
 * @authors Tamino, Salvatore, Andreas (ADV Boeblingen, I32-2016/17)
 * @license ISC License (ISC)
 * @since   2017-03-29
 *
 * Diese Klasse implementiert die Schnittstelle zur SAP.
 *
 */
...
public class ProductCatalog {
     ...
     *
     * System.out.println("\n\nGET LIST"); Vector<String> v_ProductCatalogs =
     * getList(); for (int i=0; i<v_ProductCatalogs.size(); i++) {
     * System.out.println(v_ProductCatalogs.get(i)); }
     *
     * System.out.println("\n\nGET VARIANTS"); Vector<String> v_Variants =
     * getVariants("PUMPS4SALE"); for (int i=0; i<v_Variants.size(); i++) {
     * System.out.println(v_Variants.get(i)); }
     *
     * System.out.println("\n\nGET ITEMS"); List<CatalogItem> l_Items =
     * getItems("PUMPS4SALE", "001"); for (int i=0; i<l_Items.size(); i++) {
     * System.out.println(l_Items.get(i).getArea() + " --- " +
     * l_Items.get(i).getItem() + " --- " + l_Items.get(i).getMatnr() + " --- " +
     * l_Items.get(i).getName() + " --- " + l_Items.get(i).getTitle()); }
     *
     * System.out.println("\n\nGET ITEM"); CatalogItem CI = getItem("PUMPS4SALE",
     * "001", "0000000001", "0000000001"); System.out.println(CI.getMatnr() +
     * " --- " + CI.getName() + " --- " + CI.getTitle() + " --- " + CI.getArea() +
     * " --- " + CI.getItem()); }
     */
    ...
    public CatalogItem getItem(String s_catalog, String s_variant, String s_area, String s_item) {
        ...
        return new CatalogItem(
            tbl_Itemdetails.getString("MATERIAL"),
            tbl_Itemtexts.getString("NAME"),
            tbl_Itemtexts.getString("TITLE"),
            s_area,
            s_item
        );
    }
